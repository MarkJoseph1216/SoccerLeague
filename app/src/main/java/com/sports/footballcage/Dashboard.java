package com.sports.footballcage;
...
import com.sports.footballcage.Fragments.FragmentHome;
import com.sports.footballcage.Fragments.FragmentLeague;
import com.sports.footballcage.Fragments.FragmentNews;
import com.sports.footballcage.Fragments.FragmentPrivacy;
import com.sports.footballcage.Fragments.FragmentSchedules;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_privacy:
                    if (fragmentStatus.equals("Policy")) {
                        exitCount = 0;
                    } else {
                        fragmentStatus = "Policy";
                        exitCount = 0;
                        FragmentPrivacy fragmentPrivacy = new FragmentPrivacy();
                        FragmentManager managerList = getSupportFragmentManager();
                        managerList.beginTransaction().replace(R.id.dashboard_frameLayout, fragmentPrivacy, fragmentPrivacy.getTag()).commit();
                    }
                    return true;
            }
            return false;
